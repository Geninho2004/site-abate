...
>
  ...
  <div className="hidden md:flex items-center gap-6 text-sm text-slate-700">
    <a href="#abate" className="hover:text-emerald-500 transition">
      Pedido de Abate
    </a>
    ...
    <a
      ...
      className="rounded-full bg-green-500 px-6 py-3 text-white font-bold shadow-lg hover:bg-green-400 hover:scale-105 transition duration-300"
    >
      WhatsApp
    </a>
  </div>
...
>
  ...
  target="_blank"
  rel="noopener noreferrer"
  className="md:hidden fixed bottom-5 right-5 z-[999] flex items-center justify-center w-16 h-16 rounded-full bg-green-500 text-white text-3xl shadow-2xl hover:scale-110 transition duration-300"
>
  💬
</a>
    </div>
